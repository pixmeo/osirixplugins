...
#define vtksys_DATE_STAMP_MONTH         02

/** Version date integer day.  The format is DD.  */
#define vtksys_DATE_STAMP_DAY           19

/** Version date full integer.  The format is CCYYMMDD.  */
#define vtksys_DATE_STAMP_FULL          20120219
...
#define vtksys_DATE_STAMP_STRING_MONTH "02"

/** Version date string day.  The format is "DD".  */
#define vtksys_DATE_STAMP_STRING_DAY   "19"

/** Version date full string.  The format is "CCYYMMDD".  */
#define vtksys_DATE_STAMP_STRING_FULL  "20120219"

/** Version date formatted string.  The format is "CCYY-MM-DD".  */
#define vtksys_DATE_STAMP_STRING       "2012-02-19"
