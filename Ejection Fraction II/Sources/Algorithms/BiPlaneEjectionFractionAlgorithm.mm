...
-(CGFloat)compute:(NSDictionary*)rois {
	return [self ejectionFractionWithDiastoleVolume:[self volumeWithHorizontalLongAxisArea:[[rois objectForKey:DiasHorLong] roiArea]
																	  verticalLongAxisArea:[[rois objectForKey:DiasVerLong] roiArea]
																					length:[[rois objectForKey:DiasLength] MesureLength:NULL]]
									  systoleVolume:[self volumeWithHorizontalLongAxisArea:[[rois objectForKey:SystHorLong] roiArea]
