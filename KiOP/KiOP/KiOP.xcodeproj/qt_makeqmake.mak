...
QMAKE    = /usr/bin/qmake
KiOP.xcodeproj/project.pbxproj: KiOP.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o KiOP.xcodeproj/project.pbxproj KiOP.pro
